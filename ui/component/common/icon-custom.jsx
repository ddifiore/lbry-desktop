...
export const icons = {
  ...
  [ICONS.BADGE_GLOBAL_MOD]: buildIcon(
    <g>
      <path
        d="M23.25,15.75a7.669,7.669,0,0,1-6,7.5,7.669,7.669,0,0,1-6-7.5v-3a1.5,1.5,0,0,1,1.5-1.5h9a1.5,1.5,0,0,1,1.5,1.5Z"
        strokeWidth="1.5"
      />
      <path d="M17.25 15L17.25 19.5" strokeWidth="1.5" />
      <path d="M15 17.25L19.5 17.25" strokeWidth="1.5" />
      <path d="M11.24,23.225a11.25,11.25,0,1,1,11.362-15" strokeWidth="1.5" />
      <path d="M9.289,22.921C7.768,20.689,6.75,16.633,6.75,12S7.768,3.312,9.289,1.079" strokeWidth="1.5" />
      <path d="M0.775 11.25L8.25 11.25" strokeWidth="1.5" />
      <path d="M2.999 5.25L21 5.25" strokeWidth="1.5" />
      <path d="M2.048 17.25L8.25 17.25" strokeWidth="1.5" />
      <path d="M14.711,1.079a17.009,17.009,0,0,1,2.307,7.159" strokeWidth="1.5" />
    </g>
  ),
  [ICONS.BADGE_MOD]: buildIcon(
    <g>
      <path
        d="M23.25,15.75a7.668,7.668,0,0,1-6,7.5,7.669,7.669,0,0,1-6-7.5v-3a1.5,1.5,0,0,1,1.5-1.5h9a1.5,1.5,0,0,1,1.5,1.5Z"
        strokeWidth="1.5"
      />
      <path d="M17.25 15L17.25 19.5" strokeWidth="1.5" />
      <path d="M15 17.25L19.5 17.25" strokeWidth="1.5" />
      <path d="M3.000 3.750 A3.000 3.000 0 1 0 9.000 3.750 A3.000 3.000 0 1 0 3.000 3.750 Z" strokeWidth="1.5" />
      <path d="M9.174,9.317A5.251,5.251,0,0,0,.75,13.5v2.25H3l.75,7.5h4.5L8.7,18.713" strokeWidth="1.5" />
      <path d="M13.875 3.375 A2.625 2.625 0 1 0 19.125 3.375 A2.625 2.625 0 1 0 13.875 3.375 Z" strokeWidth="1.5" />
      <path d="M20.4,9a4.5,4.5,0,0,0-7.285-.71" strokeWidth="1.5" />
    </g>
  ),
};
